 ...
 * int swap
 */
#define iswap(x,y) {int _swap_tmpval_ = (x);(x) = (y);(y) = _swap_tmpval_;}

/**
 * long swap
 */
#define lswap(x,y) {long _swap_tmpval_ = (x);(x) = (y);(y) = _swap_tmpval_;}

/**
 * int sort
 */
#define isort(x,y) {if((int)(x) > (int)(y)) iswap(x,y)}

/**
 * unsigned int sort
 */
#define usort(x,y) {if((unsigned int)(x) > (unsigned int)(y)) iswap(x,y)}

/**
 * long sort
 */
#define lsort(x,y) {if((long)(x) > (long)(y)) lswap(x,y)}

/**
 * unsigned long sort
 */
#define ulsort(x,y) {if((unsigned long)(x) > (unsigned long)(y)) lswap(x,y)}
